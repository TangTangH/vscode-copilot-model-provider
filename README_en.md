...
# VS Code Copilot Models Provider

The free quota in VS Code Copilot is limited. This extension lets you add custom models.

- After installing the extension, a `Models` button appears in the bottom status bar. Click it to open the management page.
